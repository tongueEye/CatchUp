...
1. 게시글/댓글 작성
   - 사용자는 자신의 경험 공유, 질문, 조언 등을 자유롭게 게시하고, 다른 사용자들과 댓글을 통해 소통할 수 있음
2. 문의하기
   - 사용자는 관리자에게 직접 문의를 할 수 있고, 이를 통해 해결이 필요한 문제들을 처리할 수 있음
3. 급식 메뉴확인
   - 학부모들은 자녀의 급식 메뉴를 확인할 수 있음.
4. 마이페이지
   - 자신이 작성한 글과 댓글을 쉽게 관리하고, 관심 있는 게시글을 쉽게 찾아볼 수 있는 개인화된 페이지 제공
...
| --- | --- | 
| - 경로 잘못 입력했을 때 나오는 에러페이지 <br> - 홈으로 버튼 클릭 시 메인 페이지 이동  | - 전체 메뉴 |

4. 게시글 삭제 / 좋아요, 댓글 등록 및 삭제
